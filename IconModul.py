...
class icon(QWidget):
    def __init__(self):
        self.delete_icon = QIcon('icons/bin.png')
        self.edit_icon = QIcon('icons/edit.png')
        self.plus_icon = QIcon('icons/plus.png')
        self.list_icon = QIcon('icons/list-text.png')

        self.add_icon = QIcon('icons/add (1).png')
        self.error_icon = QIcon('icons/error.png')

        self.reload_icon = QIcon('icons/reload.png')
